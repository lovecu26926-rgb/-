...
# ✅ 파일명 기준으로 카테고리 변수명 통일
REVERSAL_CATS = {"추세전환"}   # reversal.csv는 추세전환만 허용
SUPERTREND_CATS = {"돌파_52W", "돌파_50", "돌파_20", "눌림목", "골든크로스"}  # supertrend.csv는 돌파/눌림목/골크 허용
...
# =========================
# CSV 재무 데이터 로드 (✅ 내부 레이블도 파일명으로 통일)
# =========================
...
def scan():
    ...
    for t in tickers:
        try:
            ...
            source        = ticker_source.get(t, "reversal")  # 기본값도 파일명 기준
